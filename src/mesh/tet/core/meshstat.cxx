...
void TetMeshCore::printfcomma(unsigned long n)
{
  unsigned long n2 = 0;
  int scale = 1;
  while (n >= 1000) {
...
int TetMeshCore::check_mesh(int topoflag)
{
...
int TetMeshCore::check_segments()
{
...
int TetMeshCore::check_delaunay(int perturb)
{
  triface tetloop;
  triface symtet;
  face checksh;
...
int TetMeshCore::check_regular(int type)
{
  triface tetloop;
  triface symtet;
  face checksh;
...
int TetMeshCore::check_conforming(int flag)
{
  triface searchtet, neightet, spintet;
  face shloop;
  face segloop;
  point eorg, edest, eapex, pa, pb, pc;
  double cent[3], radius, dist, diff, rd, len;
  bool enq;
...
void TetMeshCore::qualitystatistics()
{
  ...
  double edgelength[6], alldihed[6], faceangle[3];
  double shortest, longest;
  double smallestvolume, biggestvolume;
  double smallestratio, biggestratio;
  double smallestradiusratio, biggestradiusratio; // radius-edge ratio.
  double smallestdiangle, biggestdiangle;
  double smallestfaangle, biggestfaangle;
  double total_tet_vol, total_tetprism_vol;
  double tetvol, minaltitude;
  double cirradius, minheightinv; // insradius;
  double shortlen, longlen;
  double tetaspect, tetradius;
  double smalldiangle, bigdiangle;
  double smallfaangle, bigfaangle;
...
void TetMeshCore::memorystatistics()
{
